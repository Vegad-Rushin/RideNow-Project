        ...
        <style>
            * {
            ...
            .activity-icon {
                ...
                .activity-icon.new-driver {
                    background: #e3f2fd;
                    color: #1976d2;
                }

                .activity-icon.new-rider {
                    background: #f3e5f5;
                    color: #7b1fa2;
                }

                .activity-icon.ride-completed {
                    background: #e8f5e8;
                    color: #388e3c;
                }

                .activity-icon.support-ticket {
                    background: #fff3e0;
                    color: #f57c00;
                }
            ...
            <div class="container">
                ...
                <div class="welcome-section">
                    ...
                    <p class="welcome-subtitle">
                        Monitor and manage your transportation platform with real-time insights and analytics
                    </p>
                </div>
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-number">
                            <asp:Literal ID="litTotalDrivers" runat="server">0</asp:Literal></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number">
                            <asp:Literal ID="litTotalRiders" runat="server">0</asp:Literal></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number">
                            <asp:Literal ID="litTotalRides" runat="server">0</asp:Literal></div>
                        <div class="stat-label">
                            Total Rides
                        </div>
                        <div class="stat-change positive">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="activities-section">
                            ...
                            <asp:Repeater ID="rptRecentActivities" runat="server" OnItemDataBound="rptRecentActivities_ItemDataBound">
                                <ItemTemplate>
                                    <div class="activity-item">
                                        <div id="divActivityIcon" runat="server" class="activity-icon">
                                            <i id="iActivityIcon" runat="server"></i>
                                        </div>
                                        <div class="activity-content">
                                            <h6>
                                                <asp:Literal ID="litActivityType" runat="server"></asp:Literal></h6>
                                            <small>
                                                <asp:Literal ID="litActivityDetail" runat="server"></asp:Literal></small>
                                        </div>
                                        <div class="activity-time">
                                            <%# FormatTimeAgo(Eval("created_at")) %>
                                        </div>
                                    </div>
                                </ItemTemplate>
                            </asp:Repeater>

                            <%-- This is shown if there are no activities --%>
                            <asp:Literal ID="litNoActivities" runat="server" Visible="false"
                                Text="<div style='text-align:center; padding: 20px;'>No recent user registrations.</div>">
                            </asp:Literal>
                        </div>
                        ...
                        <div class="notifications-section">
                            ...
                            <div class="notification-item">
                                ...
                                <div class="notification-content">
                                    ...
                                    <p>
                                        Driver Alice Lee has been suspended
                                    </p>
                                </div>
                                <div class="notification-time">
                                    3 hours ago
                            ...
                            <div class="notification-item">
                                ...
                                <div class="notification-content">
                                    ...
                                    <p>
                                        Real-time tracking feature deployed
                                    </p>
                                </div>
                                <div class="notification-time">
                                    1 day ago
                            ...
                            <div class="notification-item">
                                ...
                                <div class="notification-content">
                                    ...
                                    <p>
                                        December 2023 report is available
                                    </p>
                                </div>
                                <div class="notification-time">
                                    2 days ago
