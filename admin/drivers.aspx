...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <head>
        ...
        <title>Drivers Management - RideNow Admin</title>
            ...
            <div class="container">
                ...
                <div class="stats-cards">
                    <div class="stat-card">
                        <div class="stat-number">
                            <asp:Literal ID="litTotalDrivers" runat="server">0</asp:Literal>
                        </div>
                    ...
                    <div class="stat-card">
                        <div class="stat-number">
                           <asp:Literal ID="litActiveDrivers" runat="server">0</asp:Literal>
                        </div>
                        <div class="stat-label">
                            Active Drivers
                        </div>
                ...
                <div class="drivers-table-container">
                    ...
                    <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="#" class="btn-action btn-edit" title="Edit Driver"><i class="fa fa-edit"></i></a>
                                            <a href="#" class="btn-action btn-delete" title="Delete Driver"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        ...
                        <asp:Literal ID="litNoDrivers" runat="server" Visible="False">
