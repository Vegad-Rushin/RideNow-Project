...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
                                ...
                                <div class="col-lg-6">
                                    <div class="welcome-content">
                                        ...
                                        <p class="welcome-subtitle">
                                            ...
                                            <asp:Label ID="lblMessage" runat="server" CssClass="text-success" Visible="false" style="display: block; margin-bottom: 15px; color:black; font-size:22px; font-weight:700;"></asp:Label>
                                        ...
                                        <div class="quick-actions">
                                          ...
                                          <button type="button" onclick="window.location.href='dashboard.aspx'" class="btn btn-primary btn-lg"><i class="fa fa-dashboard"></i>Back to Dashboard </button>
                                            ...
                                            <asp:LinkButton ID="btnSaveChanges" runat="server" OnClick="btnSaveChanges_Click" CssClass="btn btn-outline btn-lg">
        ...
        <div class="profile-form">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtDateOfBirth" runat="server" CssClass="form-control" required="true" TextMode="Date"></asp:TextBox>
                </div>
                <div class="form-group">
                    <label>License Number</label>
                    <asp:TextBox ID="txtLicenseNumber" runat="server" CssClass="form-control" required="true"></asp:TextBox>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="vehicle-form">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtVehicleType" runat="server" CssClass="form-control" required="true"></asp:TextBox>
                                                        </div>
    ...
    <asp:TextBox ID="txtLicensePlate" runat="server" CssClass="form-control" required="true"></asp:TextBox>
</div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group">
    <label>Year</label>
    <asp:TextBox ID="txtYear" runat="server" CssClass="form-control" required="true" TextMode="Number"></asp:TextBox>
</div>
