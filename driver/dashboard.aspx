                ...
                <div class="header-content">
                    ...
                    <nav id="nav-menu-container">
                        <ul class="nav-menu">
                            ...
                            <li>
                                <asp:LinkButton ID="btnLogout" runat="server" OnClick="btnLogout_Click" CssClass="signup-btn">Logout</asp:LinkButton></li>
                        </ul>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="welcome-content">
                            <h1 class="welcome-title">Welcome back,
                                <asp:Literal ID="litDriverName" runat="server">Driver</asp:Literal>!</h1>
                            <p class="welcome-subtitle">
                                Ready to drive? Let's get you connected with riders and earning money.
                            </p>
                            ...
                            <div class="card-body">
                                <div class="profile-avatar">
                                    ...
                                    <div class="profile-info">
                                        <h4>
                                            <asp:Literal ID="litProfileName" runat="server">Driver Name</asp:Literal></h4>
                                        <p>
                                            Professional Driver
                                        </p>
                                    </div>
                                ...
                                <div class="profile-details">
                                    <div class="detail-item">
                                        <i class="fa fa-car"></i>
                                        <span>
                                            <asp:Literal ID="litVehicleInfo" runat="server">Vehicle Info</asp:Literal></span>
                                    </div>

                                    <div class="detail-item">
                                        <i class="fa fa-id-card"></i>
                                        <span>License:
                                            <asp:Literal ID="litLicensePlate" runat="server">Not Available</asp:Literal></span>
                                    </div>

                                </div>
                                <a href="profile.aspx" class="btn btn-outline btn-block">
